...
<Info>
**Framework Guides:** If you're using Next.js, React, or another framework, we recommend checking out our [framework guides](/essentials/nextjs-setup) for optimized setup instructions.
</Info>
...
6. **Data Processing**: Events are processed and sent to your ingestion server
...
The SDK automatically tracks common user interactions without any additional code:

### Button Clicks
```javascript
// Automatically tracked when users click any button
{
...
### Link Clicks
```javascript
// Automatically tracked when users click any link
{
...
### Form Submissions
```javascript
// Automatically tracked when users submit any form
{
...
const tracker = HumanBehaviorTracker.init('your-api-key', {
  automaticTrackingOptions: {
    trackButtons: true,
    trackLinks: false,  // Don't track links
    trackForms: true,
    includeText: true,
