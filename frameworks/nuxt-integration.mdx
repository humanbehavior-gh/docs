...
2. Let you select **Nuxt.js** from the framework options
3. Automatically install and configure the SDK for your Nuxt project:
   - Install the `humanbehavior-js` package
   - Create plugins/humanbehavior.client.ts
   - Update nuxt.config.ts with runtime config
   - Configure environment variables
   - Set up proper Nuxt integration
