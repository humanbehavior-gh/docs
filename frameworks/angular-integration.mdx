...
export class MyComponent implements OnInit {
  private tracker = initializeHumanBehavior(environment.humanBehaviorApiKey);
...
Angular uses its own environment system with `environment.ts` files. The wizard will automatically create these files for you.
