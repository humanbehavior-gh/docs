...
Select **Option 1: Manual AI-Enhanced** and then choose **Next.js** from the framework list:
...
1. Analyze your Next.js codebase for optimal integration
2. Detect your Next.js version and configuration (App Router vs Pages Router)
3. Install dependencies and create necessary files
4. Add the HumanBehaviorProvider to your app
5. Configure environment variables
6. Provide Next.js-specific optimizations and recommendations
