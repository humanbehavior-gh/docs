...
- 🔍 Detect your Next.js project (App Router or Pages Router)
- 📦 Install the humanbehavior-js package
- ✏️ Create providers.tsx and update your layout
- 🔧 Create environment files with your API key
- 🚀 Make your app ready to track user behavior

**Version Compatibility**: The wizard automatically detects your Next.js version and setup:
- **App Router** (Next.js 13+): Detects `src/app/layout.tsx`
- **Pages Router** (Next.js 12 and earlier): Detects `src/pages/_app.tsx`
- TypeScript support
