...
<Note>
**For frameworks with Server Components** (like Next.js 13+ App Router): Consider creating a separate providers file marked with `'use client'` to maintain optimal performance. See the [Next.js setup guide](/frameworks/nextjs-setup) for the recommended pattern.
</Note>
...
**Client-side identification (if needed):**
```tsx
