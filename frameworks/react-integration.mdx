...
- 🔍 Detect your React project
- 📦 Install the humanbehavior-js package
- ✏️ Add HumanBehaviorProvider to your App component
- 🔧 Create environment files with your API key
- 🚀 Make your app ready to track user behavior

**Version Compatibility**: The wizard works with most React versions and automatically detects:
- TypeScript support (`typescript` or `@types/react`)
- Router usage (`react-router-dom` or `react-router`)
