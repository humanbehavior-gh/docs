...
<Note>
  Version 0.1.4 includes enhanced session persistence, improved navigation tracking, automatic event tracking, and comprehensive health endpoint monitoring for a more robust user experience.
</Note>
