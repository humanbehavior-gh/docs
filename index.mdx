...
When you run this command, you'll see several installation options:
...
Select **Option 1: Manual AI-Enhanced** to:
1. Choose your framework from the list:
   ```bash
   ...
   ```
2. Let the AI analyze your codebase for optimal integration
3. Get framework-specific optimizations and recommendations
4. Have the wizard automatically:
...
<Note>
  The wizard supports React, Next.js, Vue, Angular, Svelte, Nuxt, Remix, and vanilla JS/TS projects.
</Note>
...
<head>
	...
	<script>const tracker = HumanBehaviorTracker.init(process.env.HUMANBEHAVIOR_API_KEY);</script>
</head>
<body>
