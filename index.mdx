...
For the best user tracking experience, identify users server-side in your authentication events:
...
<Note>
  <b>Version:</b> This documentation covers HumanBehavior SDK version 0.3.1
</Note>
...
7. **User Identification**: Users are identified server-side during authentication
