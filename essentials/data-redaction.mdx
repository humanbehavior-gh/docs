...
<Note>
  **Version Requirement**: Data redaction is available in version 0.0.7 and later. Enhanced redaction capabilities are available in version 0.0.9+. Make sure you're using at least version 0.0.7 of the SDK.
</Note>
...
<Note>
  **Version 0.0.8**: Enhanced redaction processing with improved element detection and better handling of dynamic content.
</Note>
