...
<Note>
  **Version Requirement**: Data redaction is available in version 0.1.0 and later. Enhanced redaction capabilities are available in version 0.1.3+. Make sure you're using at least version 0.1.0 of the SDK.
</Note>
...
<Note>
  **Version 0.1.3**: Enhanced redaction processing with improved element detection and better handling of dynamic content.
</Note>
