...
<Note>
  **Version 0.1.4**: Enhanced React integration with improved SSR support, better error handling, full access to all tracker methods through the hook interface, and comprehensive health endpoint monitoring.
</Note> 