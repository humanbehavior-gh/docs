...
<Note>
  **Version 0.0.8**: Enhanced React integration with improved SSR support, better error handling, and full access to all tracker methods through the hook interface.
</Note> 