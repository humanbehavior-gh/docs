...
<Note>
  **Version 0.1.3**: Enhanced React integration with improved SSR support, better error handling, and full access to all tracker methods through the hook interface.
</Note> 